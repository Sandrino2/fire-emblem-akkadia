...
lvlup_tab_ui_resize = ImageTk.PhotoImage(lvlup_tab_ui.resize([1000,600]))
...
def lvlup_name_edit(levelup_var):
    ...
    lvlup_tab_ui_new = ImageTk.PhotoImage(lvlup_tab_ui.resize([1000, 600]))
    lvlup_tab_ui_label.configure(image=lvlup_tab_ui_new)
    lvlup_tab_ui_label.image = lvlup_tab_ui_new

def lvlup_class_edit(levelup_var):
...
def lvlup_level_edit(levelup_var):
...
def lvlup_vit_plus1_bg_edit():
    levelup_var = 1
    levelup_vit_num_edit(levelup_var)
def lvlup_vit_plus2_bg_edit():
    levelup_var = 2
    levelup_vit_num_edit(levelup_var)
def levelup_vit_num_edit(levelup_var):
...
def lvlup_mgt_plus1_bg_edit():
    levelup_var = 1
    levelup_mgt_num_edit(levelup_var)
def lvlup_mgt_plus2_bg_edit():
    levelup_var = 2
    levelup_mgt_num_edit(levelup_var)
def levelup_mgt_num_edit(levelup_var):
...
def lvlup_mnd_plus1_bg_edit():
    levelup_var = 1
    levelup_mnd_num_edit(levelup_var)
def lvlup_mnd_plus2_bg_edit():
    levelup_var = 2
    levelup_mnd_num_edit(levelup_var)
def levelup_mnd_num_edit(levelup_var):
...
def lvlup_skl_plus1_bg_edit():
    levelup_var = 1
    levelup_skl_num_edit(levelup_var)
def lvlup_skl_plus2_bg_edit():
    levelup_var = 2
    levelup_skl_num_edit(levelup_var)
def levelup_skl_num_edit(levelup_var):
...
def lvlup_spd_plus1_bg_edit():
    levelup_var = 1
    levelup_spd_num_edit(levelup_var)
def lvlup_spd_plus2_bg_edit():
    levelup_var = 2
    levelup_spd_num_edit(levelup_var)
def levelup_spd_num_edit(levelup_var):
...
def lvlup_luk_plus1_bg_edit():
    levelup_var = 1
    levelup_luk_num_edit(levelup_var)
def lvlup_luk_plus2_bg_edit():
    levelup_var = 2
    levelup_luk_num_edit(levelup_var)
def levelup_luk_num_edit(levelup_var):
...
def lvlup_def_plus1_bg_edit():
    levelup_var = 1
    levelup_def_num_edit(levelup_var)
def lvlup_def_plus2_bg_edit():
    levelup_var = 2
    levelup_def_num_edit(levelup_var)
def levelup_def_num_edit(levelup_var):
...
def lvlup_spr_plus1_bg_edit():
    levelup_var = 1
    levelup_spr_num_edit(levelup_var)
def lvlup_spr_plus2_bg_edit():
    levelup_var = 2
    levelup_spr_num_edit(levelup_var)
def levelup_spr_num_edit(levelup_var):
...
lvlup_export_button = Button(tab_levelup, text='Export', command=lvlup_export_image)
