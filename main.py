...
VIT_plus1_button.place(x=138, y=273)
MGT_plus1_button.place(x=138, y=305)
MND_plus1_button.place(x=138, y=337)
SKL_plus1_button.place(x=138, y=369)
SPD_plus1_button.place(x=138, y=401)
LUK_plus1_button.place(x=138, y=433)
DEF_plus1_button.place(x=138, y=465)
SPR_plus1_button.place(x=138, y=497)
VIT_plus2_button.place(x=172, y=273)
MGT_plus2_button.place(x=172, y=305)
MND_plus2_button.place(x=172, y=337)
SKL_plus2_button.place(x=172, y=369)
SPD_plus2_button.place(x=172, y=401)
LUK_plus2_button.place(x=172, y=433)
DEF_plus2_button.place(x=172, y=465)
SPR_plus2_button.place(x=172, y=497)
...
VIT_levelup_input.place(x=94, y=274)
MGT_levelup_input.place(x=94, y=306)
MND_levelup_input.place(x=94, y=338)
SKL_levelup_input.place(x=94, y=370)
SPD_levelup_input.place(x=94, y=402)
LUK_levelup_input.place(x=94, y=434)
DEF_levelup_input.place(x=94, y=466)
SPR_levelup_input.place(x=94, y=498)
# </editor-fold>
